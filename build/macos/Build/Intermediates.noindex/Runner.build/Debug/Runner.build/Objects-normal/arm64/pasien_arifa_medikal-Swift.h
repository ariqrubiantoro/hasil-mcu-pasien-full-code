...
#ifndef PASIEN_ARIFA_MEDIKAL_SWIFT_H
#define PASIEN_ARIFA_MEDIKAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pasien_arifa_medikal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20pasien_arifa_medikal11AppDelegate")
...
SWIFT_CLASS("_TtC20pasien_arifa_medikal17MainFlutterWindow")
